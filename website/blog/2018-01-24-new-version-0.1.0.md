...
For the first drop, I really can't finish all the legacy features, but I will work more hard to finish them by March or April. Please see the [**release plan**](/react-bootstrap-table-ng/blog/2018/01/24/release-plan) for more details.
...
### New Features
- We support nested data field, please check [column.dataField](/react-bootstrap-table-ng/docs/column-props#columndatafield-required-string), fix [react-bootstrap-table#50](https://github.com/AllenFang/react-bootstrap-table/issues/50)
- We support the overlay/loading on table

### Enhancement
- One table structure, never unalign again.
- Remote enhancement, please read [**it**](/react-bootstrap-table-ng/docs/basic-remote).
- 100% easy to customize the [**header columns, cells**](/react-bootstrap-table-ng/docs/basic-column) and [**rows**](/react-bootstrap-table-ng/docs/basic-row)!!!
