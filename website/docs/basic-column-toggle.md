...
`react-bootstrap-table-ng` support a toggle list for user to toggle the column visibility.

**[Live Demo For Column Toggle](pathname:///react-bootstrap-table-ng/storybook/index.html?selectedKind=Column%20Toggle)**  
