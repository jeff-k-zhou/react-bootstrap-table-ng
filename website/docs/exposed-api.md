...
`react-bootstrap-table-ng` support some hooks function that you can use to know what state changes, for example: a row is select or unselect.
...
**[Live Demo](pathname:///react-bootstrap-table-ng/storybook/index.html?selectedKind=Basic%20Table&selectedStory=Exposed%20API)**   
