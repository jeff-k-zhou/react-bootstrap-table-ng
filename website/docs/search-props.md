...
## search.searchFormatted - [Bool] {#searchsearchformatted-bool}

If you want to search on the formatted data, you are supposed to enable this prop. `react-bootstrap-table-ng` will check if you define the [column.formatter](./column-props#columnformatter-function) when doing search.
...
## search.defaultSearch - [String] {#searchdefaultSearch-string}
...
## search.onColumnMatch - [Function] {#searchoncolumnmatch-function}
...
## search.afterSearch - [Function] {#searchaftersearch-function}
