...
* Steps to reproduce.
* `react-bootstrap-table-ng` version.

Additionally, asking questions and requesting new features are welcomed via [issue tracker](https://github.com/jeff-k-zhou/react-bootstrap-table-ng/issues).

# Pull Requests
Check [here](./docs/development.md) for getting started with development.

* PR base is `develop` branch
* We recommend filing an [issue](https://github.com/jeff-k-zhou/react-bootstrap-table-ng/issues) before you implement any new features.
...
# For the members of react-bootstrap-table-ng
